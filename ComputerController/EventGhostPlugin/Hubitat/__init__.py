...
eg.RegisterPlugin(
    ...
    version = version,
    guid = "{4E49F9F6-9621-4808-997C-9F5BD820D3F4}",
    description = ur'''<rst>
Connects to Hubitat Evolution Hub, Sending and reciving events

A fork of the webserver plugin, fitted to work with hubitat and striped down of unnecessary functionality

Plugin version: %s

.. _article:    https://community.hubitat.com/t/78640

''' % version,
    createMacrosOnAdd = False,
    canMultiLoad = True,
    icon = (
        ""
    ),
    url = "https://community.hubitat.com/t/78640",
)
import wx
import socket
...
class MyServer(ThreadingMixIn, HTTPServer):
    ...
    def Start(self):
        ...
        self.httpdThread = Thread(name="HubitatThread", target = self.Run)
...
class MyHTTPRequestHandler(SimpleHTTPRequestHandler):
    ...
    def on_ws_message(self, message):
        ...
        if not isinstance(data, dict) or "method" not in data.iterkeys():
            #Hubitat JSON message 
            #payload = (self.clAddr, data["params"])
    ...
    def handle_one_request(self):
        if not self.handshake_done:
            try:
                ...
                eg.PrintError(
                    "Hubitat: Exception on handle_one_request:",
                    unicode(exc)
                )
            #SimpleHTTPRequestHandler.handle_one_request(self)
...
### krambriw
            ...
            # ping
                ...
                #print 'ping'
                self.write_message2(_pong,decoded)
...
###
    ...
    def write_message2(self, opcode, message):
        try:
                ...
                if data[0]=="GetGlobalValue":
                    ...
                    while i < len(data):
                        try:
                            ...
                            print "Hubitat: ExecuteScript Error: data[i] = ", data[i]
                            content += "False"
                            raise
                        i += 1
                        if i < len(data):
...
# Enhancement by Sem;colon - END
    ...
    def do_GET(self):
        ...
        try:
            ...
            self.plugin.EndLastEvent()
            eg.PrintError("Hubitat error", self.path)
...
class WsBroadcastMessage(eg.ActionBase):
    ...
    class text:
        mess = "Command:"
        err = 'Error in action "Hubitat broadcast message(%s)"'
    ...
    def Configure(
        ...
        messLabel = wx.StaticText(panel, -1, text.mess)
        mainSizer = wx.BoxSizer(wx.VERTICAL)
        mainSizer.Add(messLabel,0,wx.TOP,10)
        mainSizer.Add(messCtrl,0,wx.EXPAND|wx.TOP,2)
    ...
    def __call__(self, event="", host="", user="", password=""):
        ...
        try:
            ...
            if not matchobj:
                ...
                eg.PrintError("Hubitat: " + text.msg4)
                #authheader=b'Basic ' + b64encode(user + b':' + password)
                return None
            scheme = matchobj.group(1)
            realm = matchobj.group(2)
            if scheme.lower() != 'basic':
                eg.PrintError("Hubitat: " + text.msg5)
                return None
            ...
            try:
                ...
                eg.PrintError("Hubitat: Error " + str(e.code if hasattr(e, "code") else e) + ": " + text.msg6)
                return None
...
"unsecure protocol (http). "
        ...
        started = "Hubitat started on port %i"
        secur = (
            "secured (https://)",
            "unsecured (http://)",
        )
        stopped = "Hubitat on port %i stopped"
    ...
    def ProcessTheArguments(
        ...
        if methodName == "GetGlobalValue":
            ...
            try:
                ...
                print "Hubitat: ExecuteScript Error: args[0] = ", args[0]
                result = None
                raise
...
class JumpIf(eg.ActionBase):
    ...
    class text:
        ...
        err0 = 'Hubitat: The variable "%s" does not exist.'
        err1 = "Hubitat: Evaluation of expression '%s' failed."
...
ACTIONS = (
    (WsBroadcastMessage,
            'Send Event To Hubs',
            '''Broadcasts an to all the connceted hubs''',
            None
            )
